...
function createProvisionalZooExcursion(events: FestivalEvent[]) {
  ...
  return {
    ...
    publicationStatus: 'Новая дата',
    hiddenFromPublic: false,
    accessLabel: 'Результаты розыгрыша сохраняются',
    dateLabel: '12 июля 2026 (воскресенье)',
    monthLabel: 'Июль',
    monthAnchor: 'july',
    timeLabel: '14:00',
    ...
    affiliation: '',
    heroRole: '',
    summary: 'Экскурсия «Слон по городу идёт» состоится 12 июля в 14:00; результаты розыгрыша сохраняются, повторная заявка не нужна. Коммерческий билет на экскурсию можно купить на сайте Калининградского зоопарка — эта ссылка не касается уже выигравших участников розыгрыша. Экскурсия из цикла «Другой зоопарк» расскажет о малоизвестных страницах послевоенной истории зоопарка и о том, как менялся зоопарк после немецкой эпохи.',
    whyGo: 'Экскурсия задумана как весёлая и полная необычных зоопарковых историй прогулка по советскому слою Калининградского зоопарка.',
    speakerAbout: '',
    questions: [],
    ...
    icsUrl: undefined,
    calendarNote: 'Экскурсия состоится 12 июля 2026 года в 14:00. Результаты розыгрыша сохраняются; коммерческий билет не нужен уже выигравшим участникам.',
    kind: 'special' as const,
    isoStart: '2026-07-12T14:00:00',
    showingsLabel: '12 июля 14:00 · результаты розыгрыша сохраняются',
    speakerImages: [],
...
function createYantarExcursion(): FestivalEvent {
  ...
  return {
    ...
    affiliation: '',
    heroRole: '',
    showingsLabel: '16 июля 18:00 · 12 мест в розыгрыше · 10 мест резерв',
