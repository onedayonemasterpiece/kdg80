...
function createProvisionalZooExcursion(events: FestivalEvent[]) {
  ...
  return {
    ...
    affiliation: '',
    heroRole: '',
    summary: 'Экскурсия состоится 12 июля в 14:00; результаты розыгрыша сохраняются, повторная заявка не нужна. Коммерческий билет на экскурсию можно купить на сайте Калининградского зоопарка — эта ссылка не касается уже выигравших участников розыгрыша. Премьера лучше раскроет, что появилось в зоопарке в советское время, познакомит с историей зоопарка того периода и покажет вживую, как менялся зоопарк после немецкой эпохи.',
